...
def get_ip_data():
    ...
    input_brand = input(" What is the band of this device? ")
    input_planet = input("What planet did this come from? ")
    d = {"IP": input_ip, "driver": input_driver, "brand": input_brand, "planet": input_planet}
    return d
